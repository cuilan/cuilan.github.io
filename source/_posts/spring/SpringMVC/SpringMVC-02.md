...
![DispatcherServlet继承关系](SpringMVC-02/02-1.png)
...
![HttpServletBean.init()方法](SpringMVC-02/02-2.png)
...
![web.xml配置文件](SpringMVC-02/02-3.png)
...
![initServletBean()方法](SpringMVC-02/02-4.png)
...
![initWebApplicationContext()方法](SpringMVC-02/02-5.png)
...
![initFrameworkServlet()方法](SpringMVC-02/02-6.png)
...
![onRefresh()方法](SpringMVC-02/02-8.png)
...
![doGet()方法](SpringMVC-02/02-9.png)
...
![processRequest()方法](SpringMVC-02/02-10.png)

## 3.doService()方法

DispatcherServlet覆写的 **`doService()`** 方法：

![doService()方法](SpringMVC-02/02-11.png)
...
![doDispatch()方法](SpringMVC-02/02-12.png)
