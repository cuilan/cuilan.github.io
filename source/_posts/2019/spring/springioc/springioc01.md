...
![SpringXML注入](https://img.cuilan.org/2019/springioc01/1.png)

getBean

![SpringXML注入](https://img.cuilan.org/2019/springioc01/2.png)

## 2. JavaConfig+@Bean（可以注入第三方的类）

![JavaConfig](https://img.cuilan.org/2019/springioc01/3.png)
...
![ComponentScans注解](https://img.cuilan.org/2019/springioc01/4.png)
...
![Import](https://img.cuilan.org/2019/springioc01/5.png)

### 2) ImportSelector：返回需要导入的组件的全类名数组。

ImportConfig

![ImportSelector](https://img.cuilan.org/2019/springioc01/6.png)

MyImportSelector

![ImportSelector](https://img.cuilan.org/2019/springioc01/7.png)

### 3) ImportBeanDefinitionRegistrar：手动注册 Bean 到容器中

ImportConfig

![ImportBeanDefinitionRegistrar](https://img.cuilan.org/2019/springioc01/8.png)

MyImportBeanDefinitionRegistrar

![ImportBeanDefinitionRegistrar](https://img.cuilan.org/2019/springioc01/9.png)

## 5. FactoryBean（注册工厂 Bean）

FactoryBean

![FactoryBean](https://img.cuilan.org/2019/springioc01/10.png)
![FactoryBean](https://img.cuilan.org/2019/springioc01/11.png)
...
![FactoryBean](https://img.cuilan.org/2019/springioc01/12.png)
