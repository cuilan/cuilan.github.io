...
categories:
- Spring
excerpt: SpringMVC核心分发器DispatcherServlet分析
---
...
![DispatcherServlet继承关系](https://img.cuilan.org/2019/springmvc/02-1.png)
...
![HttpServletBean.init()方法](https://img.cuilan.org/2019/springmvc/02-2.png)
...
![web.xml配置文件](https://img.cuilan.org/2019/springmvc/02-3.png)
...
![initServletBean()方法](https://img.cuilan.org/2019/springmvc/02-4.png)
...
- **初始化initFrameworkServlet**

## 1.初始化WebApplicationContext

![initWebApplicationContext()方法](https://img.cuilan.org/2019/springmvc/02-5.png)
...
![initFrameworkServlet()方法](https://img.cuilan.org/2019/springmvc/02-6.png)
...
![根上下文](https://img.cuilan.org/2019/springmvc/02-7.png)
...
![onRefresh()方法](https://img.cuilan.org/2019/springmvc/02-8.png)
...
![doGet()方法](https://img.cuilan.org/2019/springmvc/02-9.png)
...
![processRequest()方法](https://img.cuilan.org/2019/springmvc/02-10.png)

## 3.doService()方法

DispatcherServlet覆写的 **`doService()`** 方法：

![doService()方法](https://img.cuilan.org/2019/springmvc/02-11.png)
...
![doDispatch()方法](https://img.cuilan.org/2019/springmvc/02-12.png)
