...
![HashMap继承关系](https://img.cuilan.org/2019/HashMap1.png "HashMap继承关系")
...
<a href="#8">**八、其他主要方法**</a>
<a href="#9">九、迭代器</a>
<a href="/2019/09/11/2019/java-util/HashMap-TreeNode/">**十、<font color="red">红</font><font color="black">黑</font>树**</a>
...
当哈希表某一位置处的链表达到 8 个以上，并且哈希表的长度大于 64，该位置的链表会转换为一种 **平衡二叉树**：<a href="/2019/09/11/2019/java-util/HashMap-TreeNode/#3">**红黑树**</a>。

![HashMap数据结构](https://img.cuilan.org/2019/HashMap-Tree.png "HashMap数据结构")
...
![HashMap.Node结构](https://img.cuilan.org/2019/HashMap-Node.png "HashMap.Node结构")
