...
![Nginx反向代理](https://img.cuilan.org/2018/nginx-high1.png)
...
![轮询](https://img.cuilan.org/2018/nginx-high2.png)

### 2.ip_hash

访问固定的一台后端服务器，可以保证 session。
![ip_hash](https://img.cuilan.org/2018/nginx-high3.png)

### 3.权重(weight)

分配轮询的比重，weight 值越高，访问的几率越大，权重值跟请求几率成正比。
![权重](https://img.cuilan.org/2018/nginx-high4.png)

### 4.响应时间

响应时间最短的优先分配。
![响应时间](https://img.cuilan.org/2018/nginx-high5.png)

### 5.url_hash

根据 url 计算来确定访问哪台主机，配置 hash。
![url_hash](https://img.cuilan.org/2018/nginx-high6.png)
